...
Public services like <github.com> and <gitlab.com> offer both methods, and you'll find detailed setup guides in their help resources.
...
`r DiagrammeR::DiagrammeR("../diagrams/add-commits.mmd")`
...
`r DiagrammeR::DiagrammeR("../diagrams/commit-tree.mmd")`
...
`r DiagrammeR::DiagrammeR("../diagrams/add-commits-branch.mmd")`
