...
In order to work on a Git project, you need the working copy, the root folder of your project.
This location is where Git can restore complete or partial project states, and where Git looks for new changes.
