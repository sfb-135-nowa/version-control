...
When a new repository is created, Git creates a primary branch as a starting point to work with immediately.
...
Afterwards, Git automatically creates and activates a primary branch one can immediately work with.
